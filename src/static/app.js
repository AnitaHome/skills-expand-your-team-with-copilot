document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // Apply difficulty filter: when a level is selected, only show activities
      // with that exact difficulty. Activities without a difficulty field are
      // shown only when "All" (empty string) is selected.
